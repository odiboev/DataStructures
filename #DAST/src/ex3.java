...
public class ex3 {
    ...
    public static int getMaxMinValue(int[] myArray) {              //Q2
        ...
        System.out.println("Index of Maximum Value: " + java.util.Arrays.binarySearch(myArray, maxValue));
        System.out.println("\nMinimum Value: " + minValue);
        System.out.println("Index of Minimum Value: " + java.util.Arrays.binarySearch(myArray, minValue));
        return maxValue;
    }
